...
#Este es el comando para que se ejecute todo desdesa
# curl -fsSL https://raw.githubusercontent.com/Jhon-Cortez/BJJMarket/develop/scripts/deploy-ubuntu.sh | bash
...
printf 'Frontend disponible en el puerto: 5173\n'
printf 'Backend disponible en el puerto: 9090\n'
printf 'Swagger disponible en el puerto: 9090\n'
